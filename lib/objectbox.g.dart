...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 7780798671899711417),
      name: 'UserEntity',
      lastPropertyId: const obx_int.IdUid(5, 8985974769215936889),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 43191171231110578),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 444687351901208706),
            name: 'userId',
            type: 9,
            flags: 34848,
            indexId: const obx_int.IdUid(1, 3668210332295040328)),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 6443997886375565253),
            name: 'username',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 4619199082704366590),
            name: 'inviteCode',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(5, 8985974769215936889),
            name: 'emailId',
            type: 9,
            flags: 0)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 7780798671899711417),
      lastIndexId: const obx_int.IdUid(1, 3668210332295040328),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    UserEntity: obx_int.EntityDefinition<UserEntity>(
        ...
        objectToFB: (UserEntity object, fb.Builder fbb) {
          ...
          final emailIdOffset = fbb.writeString(object.emailId);
          fbb.startTable(6);
          fbb.addInt64(0, object.id ?? 0);
          fbb.addOffset(1, userIdOffset);
          fbb.addOffset(2, usernameOffset);
          fbb.addOffset(3, inviteCodeOffset);
          fbb.addOffset(4, emailIdOffset);
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final inviteCodeParam = const fb.StringReader(asciiOptimization: true)
              .vTableGet(buffer, rootOffset, 10, '');
          final object = UserEntity(
              userIdParam, usernameParam, emailIdParam, inviteCodeParam)
            ..id =
...
class UserEntity_ {
  ...
  /// see [UserEntity.inviteCode]
  static final inviteCode =
      obx.QueryStringProperty<UserEntity>(_entities[0].properties[3]);

  /// see [UserEntity.emailId]
